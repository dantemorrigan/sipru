...
(function () {
  const STRINGS = {
    ru: {
      ...
      vault_resolving: "определяем место хранения…",
      vault_skip: "пропустить — хранить только в приложении",
      ...
      vault_loc_app: "Хранилище приложения",
      vault_loc_app_note: "удаляется вместе с приложением",
      vault_loc_shared: "Документы",
      vault_loc_shared_note: "переживает переустановку",
      vault_loc_download: "Загрузки",
      vault_loc_download_note: "переживает переустановку",
      vault_loc_unavailable: "недоступно на этом устройстве",
      vault_loc_grant_hint: "чтобы разрешить: Настройки → Приложения → Writed. → Разрешения → Файлы и медиа → Доступ ко всем файлам",
      vault_checking: "проверяем доступ…",
      onb_back: "Назад",
      onb_next: "Дальше",
    ...
    en: {
      ...
      vault_resolving: "finding a place to store your work…",
      vault_skip: "skip — keep it in the app only",
      vault_title: "Vault",
      ...
      vault_loc_app: "App storage",
      vault_loc_app_note: "removed when the app is uninstalled",
      vault_loc_shared: "Documents",
      vault_loc_shared_note: "survives a reinstall",
      vault_loc_download: "Downloads",
      vault_loc_download_note: "survives a reinstall",
      vault_loc_unavailable: "not available on this device",
      vault_loc_grant_hint: "to allow it: Settings → Apps → Writed. → Permissions → Files and media → Allow all files access",
      vault_checking: "checking access…",
      onb_back: "Back",
      onb_next: "Next",
