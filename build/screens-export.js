...
`;return}if(i==="sup"&&a.classList&&a.classList.contains("fn")){e+="[^"+(a.textContent||"").trim()+"]";return}if(i==="code"){e+="`"+(a.textContent||"")+"`";return}const o=inlineToMd(a);i==="strong"||i==="b"?e+="**"+o+"**":i==="em"||i==="i"?e+="*"+o+"*":i==="u"?e+="<u>"+o+"</u>":i==="s"||i==="strike"?e+="~~"+o+"~~":i==="a"?e+="["+o+"]("+(a.getAttribute("href")||"")+")":e+=o}),e}function htmlToMd(n){const e=document.createElement("div");e.innerHTML=n||"";let a="";const i=[],o=e.querySelector(".fn-defs");return o&&(Array.prototype.forEach.call(o.children,s=>i.push((s.textContent||"").replace(/\s*\n\s*/g," "))),o.remove()),e.childNodes.forEach(s=>{if(s.nodeType===3){a+=mdEscapeText(s.textContent);return}const p=s.tagName?s.tagName.toLowerCase():"",r=s.getAttribute&&s.getAttribute("class")||"";if(p==="hr"&&r.indexOf("page-break")>=0){a+=`
<!-- page-break -->
